...
describe('favorite blog', () => {
    ...
    test('of empty list is zero', () => {
      assert.deepStrictEqual(listHelper.favoriteBlog(listWithNoBlogs), null)
    })
...
describe('author with most blogs', () => {
  ...
  test('of empty list is zero', () => {
    assert.deepStrictEqual(listHelper.mostBlogs(listWithNoBlogs), null)
  })
...
describe('author with most likes', () => {
  ...
  test('of empty list is zero', () => {
    assert.deepStrictEqual(listHelper.mostLikes(listWithNoBlogs), null)
  })
